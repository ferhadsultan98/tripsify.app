...
import { fontFamily } from "../../styles/fonts";import PhoneIcon from '../../../assets/images/phoneIcon.svg'; 
...
const DeviceManagementScreen = ({ navigation }) => {
    ...
    const [devices, setDevices] = useState([
        { id: '1', type: 'mobile', name: 'iPhone 14 Pro Max', location: 'Baku, Azerbaijan', lastActive: 'Active now', isCurrent: true },
        { id: '2', type: 'desktop', name: 'Chrome on Windows', location: 'Ganja, Azerbaijan', lastActive: '2 hours ago' },
        { id: '3', type: 'mobile', name: 'Samsung Galaxy S23', location: 'Sumgait, Azerbaijan', lastActive: 'Yesterday' },
    ]);
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                {devices.length > 1 && (
                     <TouchableOpacity style={styles.logoutAllButton} onPress={handleLogoutAll}>
                        <Text style={styles.logoutAllButtonText}>Log out of all other sessions</Text>
                    </TouchableOpacity>
                )}
            </ScrollView>
        </SafeAreaView>
...
const styles = StyleSheet.create({
    safeArea: {
        flex: 1,
        backgroundColor: '#F7F8FA', // Açıq arxa fon
    },
    scrollContent: {
        padding: 24,
    },
